...
<nav id="sidebar" class="ms-lt-5 bg-dark">
	<div class="sidebar-list">
			...
			<?php endif; ?>
				...
				<a href="index.php?page=users_alumnos" class="nav-item nav-users"><span class='icon-field'><i class="fa fa-users"></i></span> Alumnos</a>
			<?php endif; ?>
	</div>
</nav>
<script>
